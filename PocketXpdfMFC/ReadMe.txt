================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : PocketXpdfMFC Project Overview
===============================================================================

The application wizard has created this PocketXpdfMFC application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your PocketXpdfMFC application.

PocketXpdfMFC.vcproj
...
PocketXpdfMFC.h
    ...
    project specific headers and declares the CPocketXpdfMFCApp application class.

PocketXpdfMFC.cpp
    This is the main application source file that contains the application
    class CPocketXpdfMFCApp.
...
res\PocketXpdfMFCppc.rc2
    This file contains resources that are not edited by Microsoft 
    Visual C++. You should place all resources not editable by
    the resource editor in this file.


res\PocketXpdfMFC.ico
...
StdAfx.h, StdAfx.cpp
    ...
    named PocketXpdfMFC.pch and a precompiled types file named StdAfx.obj.
