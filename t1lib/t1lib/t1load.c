...
FONTSIZEDEPS *T1int_CreateNewFontSize( int FontID, float size, int aa)
{
  ...
  sprintf( err_warn_msg_buf, "New Size %d.%04d created for FontID %d (antialias=%d)",
	   (int) pFontSizeDeps->size, ((int) (pFontSizeDeps->size * 10000.0)) % 10000, FontID, pFontSizeDeps->antialias);
