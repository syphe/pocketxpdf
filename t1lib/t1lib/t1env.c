...
//extern char fseek ( FILE *file, unsigned long rel, unsigned short source );
//extern unsigned long ftell ( FILE *file );
...
#define ORIG_GLOBAL_CONFIG_DIR GLOBAL_CONFIG_DIR
	global_config_dir = relocatex (INSTALLDIR, ORIG_GLOBAL_CONFIG_DIR);
#undef GLOBAL_CONFIG_DIR
#define GLOBAL_CONFIG_DIR global_config_dir
	...
	free (global_config_dir);
#undef GLOBAL_CONFIG_DIR
#define GLOBAL_CONFIG_DIR ORIG_GLOBAL_CONFIG_DIR
#undef ORIG_GLOBAL_CONFIG_DIR
    if (cfg_fp==NULL){
