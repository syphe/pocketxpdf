...
{
	char *args[3];
	MessageBox(0,TEXT("Starting"),TEXT("Info"),MB_OK);
	args[0]="pdf2ppm";
	args[1]="\\Speicherkarte\\xpdf\\test.pdf";
	args[2]="\\Speicherkarte\\xpdf\\test";
	wchar_t str[10];
	MessageBox(0,_itow(main (3,args),str,10),TEXT("Info"),MB_OK);
	return 0;
}*/