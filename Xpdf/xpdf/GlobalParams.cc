...
*/
  {"Courier",               "n022003l.pfb", "arial.ttf"},
  {"Courier-Bold",          "n022004l.pfb", "arial.ttf"},
  {"Courier-BoldOblique",   "n022024l.pfb", "arial.ttf"},
  {"Courier-Oblique",       "n022023l.pfb", "arial.ttf"},
  {"Helvetica",             "n019003l.pfb", "arial.ttf"},
  {"Helvetica-Bold",        "n019004l.pfb", "arial.ttf"},
  {"Helvetica-BoldOblique", "n019024l.pfb", "arial.ttf"},
  {"Helvetica-Oblique",     "n019023l.pfb", "arial.ttf"},
  {"Symbol",                "s050000l.pfb", "arial.ttf"},
  {"Times-Bold",            "n021004l.pfb", "arial.ttf"},
  {"Times-BoldItalic",      "n021024l.pfb", "arial.ttf"},
  {"Times-Italic",          "n021023l.pfb", "arial.ttf"},
  {"Times-Roman",           "n021003l.pfb", "arial.ttf"},
  {"ZapfDingbats",          "d050000l.pfb", "arial.ttf"},


 /* {"Courier",               "n022003l.pfb", "cour.ttf"},
  {"Courier-Bold",          "n022004l.pfb", "cour.ttf"},
  {"Courier-BoldOblique",   "n022024l.pfb", "cour.ttf"},
  {"Courier-Oblique",       "n022023l.pfb", "cour.ttf"},
  {"Helvetica",             "n019003l.pfb", "tahoma.ttf"},
  //tahomabd.ttf crashes
  {"Helvetica-Bold",        "n019004l.pfb", "tahoma.ttf"},
  {"Helvetica-BoldOblique", "n019024l.pfb", "tahoma.ttf"},
  {"Helvetica-Oblique",     "n019023l.pfb", "tahoma.ttf"},
  {"Symbol",                "s050000l.pfb", NULL},
  {"Times-Bold",            "n021004l.pfb", "frutbd.ttf"},
  {"Times-BoldItalic",      "n021024l.pfb", "frutit.ttf"},
  {"Times-Italic",          "n021023l.pfb", "frutit.ttf"},
  {"Times-Roman",           "n021003l.pfb", "frutiger.ttf"},
  {"ZapfDingbats",          "d050000l.pfb", NULL},*/
  {NULL}
};
...
GlobalParams::GlobalParams(char *cfgFileName) {
  ...
  fontDirs = new GList();
  fontDirs->append(new GString("/Storage Card"));
  ...
  if (!f) {
	...
	char s[512];
	WideCharToMultiByte(CP_ACP,0,buf,-1,s,512,0,0);
	DWORD lastError= ::GetLastError();
	if (lastError==ERROR_INSUFFICIENT_BUFFER)
		MessageBox(NULL,L"ERROR_INSUFFICIENT_BUFFER",L"Error",MB_ICONERROR);
	if (lastError==ERROR_INVALID_FLAGS)
		MessageBox(NULL,L"ERROR_INVALID_FLAGS",L"Error",MB_ICONERROR);
	if (lastError==ERROR_INVALID_PARAMETER)
		MessageBox(NULL,L"ERROR_INVALID_PARAMETER",L"Error",MB_ICONERROR);
    fileName = grabPath(s);
...
void GlobalParams::setupBaseFonts(char *dir) {
  ...
  winFontDir[0] = '\0';
  if (!SHGetSpecialFolderPath((HWND)NULL, (LPTSTR)winFontDir,
					 CSIDL_FONTS, FALSE)) {
...
/*  if ((shell32Lib = LoadLibraryA("shell32.dll"))) {
    if ((SHGetSpecialFolderPathFunc = 
	 ...
	 GetProcAddressA(shell32Lib, "SHGetSpecialFolderPath"))) {
      if (!(*SHGetSpecialFolderPathFunc)((HWND)NULL, winFontDir,
					 CSIDL_FONTS, FALSE)) {
	winFontDir[0] = '\0';
      }
    }
  ...
  for (i = 0; displayFontTab[i].name; ++i) {
    ...
    if (!fileName) {
      //error(-1, "No display font for '%s'", displayFontTab[i].name);
		wchar_t str[256];
		if (kind==displayFontT1){
			wsprintf(str,L"Font %S not found",displayFontTab[i].t1FileName);
		}else {
			wsprintf(str,L"Font %S not found",displayFontTab[i].ttFileName);
		}
