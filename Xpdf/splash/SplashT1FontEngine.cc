...
SplashFontFile *SplashT1FontEngine::loadType1CFont(SplashFontFileID *idA,
  ...
  if (ret) {
    ...
    wchar_t *ws = new wchar_t[strlen(tmpFileName->getCString())+1];
	  MultiByteToWideChar(CP_ACP,MB_PRECOMPOSED,tmpFileName->getCString(),-1,ws, strlen(tmpFileName->getCString())+1);
